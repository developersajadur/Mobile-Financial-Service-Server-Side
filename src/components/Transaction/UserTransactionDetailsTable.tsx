...
import { useGetTransactionsDetailsByIdQuery } from "@/redux/features/Transaction/transactionApi";
import { useParams } from "react-router-dom";
import Loader from "../Loaders/Loader";

const UserTransactionDetailsTable = () => {
  const { id } = useParams<{ id: string }>();
  
  // Fetch transaction details using the correct user ID
  const { data, isLoading } = useGetTransactionsDetailsByIdQuery({ userId: id });
...
export default UserTransactionDetailsTable;
